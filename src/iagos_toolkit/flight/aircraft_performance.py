...
try:
    ...
    BADAFlight = None  # mark it as unavailable
...
def compute_aircraft_efficiency(
    ...
    if apm == "PS":
        ...
        if BADAFlight is None:
            raise ImportError(
                "BADAFlight could not be imported. "
                "Install pycontrails with the BADA extension to use this model."
            )
